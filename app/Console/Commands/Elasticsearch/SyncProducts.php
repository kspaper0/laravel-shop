...
class SyncProducts extends Command
{
     ...
     * @var string
     */
    protected $description = 'Synchorize Product into Elasticsearch';
    ...
    public function handle()
    {
        ...
        Product::query()
            ...
            ->chunkById(100, function ($products) use ($es) {
                $this->info(sprintf('Synchorizing Product ID from %s to %s', $products->first()->id, $products->last()->id));
